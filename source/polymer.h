...
public:
    ...
    const double &get_x(int i) const {
        return m_poly_x[i];
    };
    const double &get_y(int i) const {
        return m_poly_y[i];
    };
    const double &get_z(int i) const {
        return m_poly_z[i];
    };

    const double &get_fx(int i) const {
        return m_poly_fx[i];
    };
    const double &get_fy(int i) const {
        return m_poly_fy[i];
    };
    const double &get_fz(int i) const {
        return m_poly_fz[i];
    };
    ...
    void set_x(double x, int i) {
        m_poly_x[i] = x;
    };
    void set_y(double y, int i) {
        m_poly_y[i] = y;
    };
    void set_z(double z, int i) {
        m_poly_z[i] = z;
    };
    ...
    const int &get_poly_nmonomers() const {
        return m_poly_nmonomers;
    };
    const float &get_poly_d() const {
        return m_poly_d;
    };
    const float &get_spring() const {
